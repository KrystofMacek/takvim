...
final languagePackController =
  ...
  print('pack : $_langPackProvider');
  return LanguagePackController(_langPackProvider, _prayerlangPackProvider);
});

class LanguagePackController extends StateNotifier<LanguagePackController> {
  LanguagePackController(
      this._appLanguagePackProvider, this._prayerlangPackProvider)
      : super(null);
  ...
  Future<LanguagePack> getAppLangPack() async {
    print('getAppLAngPack');
    print('getAppLAngPack pack : $_appLanguagePackProvider');
